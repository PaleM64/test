...
speed() {
    ...
    speed_test '41805' 'XL Axiata JKT, ID'
    speed_test '13039' 'Indosat JKT, ID'
    speed_test '24215' 'Biznet JKT, ID'
    speed_test '11118' 'MyRepublic JKT, ID'
    speed_test '12807' 'CBN JKT, ID'
    speed_test '48112' 'VPNNEO JKT, CN'
    speed_test '48831' 'VPNNEO, SG'
    speed_test '7556' 'Firstmedia, SG'
    speed_test '6527'  'PhoenixNAP, NL'
    speed_test '7311'  'i3D NET, US'
    speed_test '27594' 'ChinaTelecom, CN'
}
